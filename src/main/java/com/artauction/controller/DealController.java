...
public class DealController {
   ...
   @GetMapping("/buy")
   public String temp(GoodsVO gVo, Model model, @Param("message") String message) {
   ...
   public String buying(GoodsVO gVo, Model model,RedirectAttributes rttr, @Param("message") String message) {
      ...
      */
      ...
      if(message != null) {
         ...
         }else if(message.equals("sessionOut")) {
